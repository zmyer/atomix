...
public class AtomixAgent {
    ...
    public static void main(String[] args) throws Exception {
        ArgumentType<MemberConfig> memberArgumentType =
                (ArgumentParser argumentParser, Argument argument, String value) -> new MemberConfig()
        ...
        LOGGER.info("Atomix listening at {}:{}", atomix.getMembershipService().getLocalMember().address().host(),
                atomix.getMembershipService().getLocalMember().address().port());
        ...
        LOGGER.info("HTTP server listening at {}:{}",
                atomix.getMembershipService().getLocalMember().address().address().getHostAddress(), httpPort);
